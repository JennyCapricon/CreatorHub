    ...
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Customize your CreatorHub link page</p>
          </div>
        </div>
      </motion.div>
      ...
      {message && (
        <div className={`p-3 rounded-xl text-sm ${
          message.includes("updated") ? "bg-green-500/10 text-green-400 border border-green-500/20" : "bg-red-500/10 text-red-400 border border-red-500/20"
        }`}>{message}</div>
      )}
      ...
      <motion.div className="card p-6 space-y-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div key={key} className="flex items-center gap-2 p-2 rounded-xl bg-white/5">
        ...
        <div>
          ...
          <div className="space-y-2 mb-4">
            {data.links.map((link) => (
              <div key={link.id} className="flex items-center gap-2 p-3 rounded-xl bg-white/5">
...
export default function LinkInBio() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="text-center">
          <Sparkles size={48} className="mx-auto text-brand-400 mb-4" />
          <h1 className="text-2xl font-bold mb-2">CreatorHub Link-in-Bio</h1>
          <p className="text-gray-400 mb-6">Create your own link page</p>
